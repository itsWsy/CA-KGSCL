...
EXP_HYPER_LIST = {'Data': {'dataset': None, 'data_aug': None, 'seq_filter_len': None, 'if_filter_target': None,
                           'use_tar_len': None, 'target_len': None, 'max_len': None, 'min_seq_len': None,
                           'max_seq_len': None},
...
def get_default_config():
    ...
    parser.add_argument('--dataset', default='toys', type=str,
                        choices=['home', 'grocery', 'grocery', 'yelp', 'toys'])
    parser.add_argument('--data_aug', action='store_false', help='data augmentation')
    parser.add_argument('--target_len', default=1, type=int, help='target length for target sequence')
    parser.add_argument('--use_tar_len', action='store_true', help='if use target sequence')
    ...
    parser.add_argument('--max_len', default=50, type=int, help='max sequence length after padding')
    parser.add_argument('--min_seq_len', default=1, type=int)
