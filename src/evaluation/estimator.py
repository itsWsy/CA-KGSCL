...
class Estimator:
    ...
    def evaluate(self, eval_loader, model):
        ...
        for _, batch in eval_iter:
            ...
            batch_input, batch_length, batch_target = batch[0], batch[1], batch[2]
            additional_data = batch[3:]
            logits = model(batch_input, batch_length, *additional_data)
    ...
    def test(self, test_loader, model):
        ...
        for i, batch in enumerate(test_loader):
            ...
            batch_input, batch_length, batch_target = batch[0], batch[1], batch[2]
            additional_data = batch[3:]
            prediction = model(batch_input, batch_length, *additional_data)
